...
namespace xakaton2024 {
	...
	public:
		...
		pictureBoxForm(String^ formtext)
		{
			InitializeComponent();
			this->Text = formtext;
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(pictureBoxForm::typeid));
			...
			this->pictureBox->Size = System::Drawing::Size(957, 550);
			...
			this->ClientSize = System::Drawing::Size(957, 550);
